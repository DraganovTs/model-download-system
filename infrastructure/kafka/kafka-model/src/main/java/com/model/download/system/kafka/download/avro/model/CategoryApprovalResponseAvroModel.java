...
public class CategoryApprovalResponseAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4863953961774339511L;
   ...
   */
  public CategoryApprovalResponseAvroModel(java.util.UUID id, java.util.UUID sagaId, java.util.UUID categoryId, java.util.UUID downloadId, java.time.Instant createdAt, com.model.download.system.kafka.download.avro.model.DownloadApprovalStatus downloadApprovalStatus, java.util.List<java.lang.String> failureMessages) {
    this.id = id;
    this.sagaId = sagaId;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 5: downloadApprovalStatus = (com.model.download.system.kafka.download.avro.model.DownloadApprovalStatus)value$; break;
   ...
   */
  public static com.model.download.system.kafka.download.avro.model.CategoryApprovalResponseAvroModel.Builder newBuilder() {
    return new com.model.download.system.kafka.download.avro.model.CategoryApprovalResponseAvroModel.Builder();
  }
   ...
   * @return A new CategoryApprovalResponseAvroModel RecordBuilder
   */
  public static com.model.download.system.kafka.download.avro.model.CategoryApprovalResponseAvroModel.Builder newBuilder(com.model.download.system.kafka.download.avro.model.CategoryApprovalResponseAvroModel.Builder other) {
    if (other == null) {
      return new com.model.download.system.kafka.download.avro.model.CategoryApprovalResponseAvroModel.Builder();
    } else {
      return new com.model.download.system.kafka.download.avro.model.CategoryApprovalResponseAvroModel.Builder(other);
    }
  }
   ...
   * @return A new CategoryApprovalResponseAvroModel RecordBuilder
   */
  public static com.model.download.system.kafka.download.avro.model.CategoryApprovalResponseAvroModel.Builder newBuilder(com.model.download.system.kafka.download.avro.model.CategoryApprovalResponseAvroModel other) {
    if (other == null) {
      return new com.model.download.system.kafka.download.avro.model.CategoryApprovalResponseAvroModel.Builder();
    } else {
      return new com.model.download.system.kafka.download.avro.model.CategoryApprovalResponseAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CategoryApprovalResponseAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.model.download.system.kafka.download.avro.model.CategoryApprovalResponseAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.model.download.system.kafka.download.avro.model.CategoryApprovalResponseAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.model.download.system.kafka.download.avro.model.CategoryApprovalResponseAvroModel.Builder setId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.model.download.system.kafka.download.avro.model.CategoryApprovalResponseAvroModel.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.model.download.system.kafka.download.avro.model.CategoryApprovalResponseAvroModel.Builder setSagaId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.model.download.system.kafka.download.avro.model.CategoryApprovalResponseAvroModel.Builder clearSagaId() {
      sagaId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.model.download.system.kafka.download.avro.model.CategoryApprovalResponseAvroModel.Builder setCategoryId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.model.download.system.kafka.download.avro.model.CategoryApprovalResponseAvroModel.Builder clearCategoryId() {
      categoryId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.model.download.system.kafka.download.avro.model.CategoryApprovalResponseAvroModel.Builder setDownloadId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.model.download.system.kafka.download.avro.model.CategoryApprovalResponseAvroModel.Builder clearDownloadId() {
      downloadId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.model.download.system.kafka.download.avro.model.CategoryApprovalResponseAvroModel.Builder setCreatedAt(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.model.download.system.kafka.download.avro.model.CategoryApprovalResponseAvroModel.Builder clearCreatedAt() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.model.download.system.kafka.download.avro.model.CategoryApprovalResponseAvroModel.Builder setDownloadApprovalStatus(com.model.download.system.kafka.download.avro.model.DownloadApprovalStatus value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.model.download.system.kafka.download.avro.model.CategoryApprovalResponseAvroModel.Builder clearDownloadApprovalStatus() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.model.download.system.kafka.download.avro.model.CategoryApprovalResponseAvroModel.Builder setFailureMessages(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.model.download.system.kafka.download.avro.model.CategoryApprovalResponseAvroModel.Builder clearFailureMessages() {
    ...
    public CategoryApprovalResponseAvroModel build() {
      try {
        ...
        record.downloadApprovalStatus = fieldSetFlags()[5] ? this.downloadApprovalStatus : (com.model.download.system.kafka.download.avro.model.DownloadApprovalStatus) defaultValue(fields()[5]);
