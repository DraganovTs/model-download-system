...
public class PaymentRequestAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4372819005368238111L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"PaymentRequestAvroModel\",\"namespace\":\"com.model.download.system.kafka.download.avro.model\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"sagaId\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"customerId\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"downloadId\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"price\",\"type\":{\"type\":\"bytes\",\"logicalType\":\"decimal\",\"precision\":10,\"scale\":2}},{\"name\":\"createdAt\",\"type\":{\"type\":\"long\",\"logicalType\":\"timestamp-millis\"}},{\"name\":\"paymentStatus\",\"type\":{\"type\":\"enum\",\"name\":\"PaymentDownloadStatus\",\"symbols\":[\"PENDING\",\"CANCELLED\"]}}]}");
  ...
  private com.model.download.system.kafka.download.avro.model.PaymentDownloadStatus paymentStatus;
   ...
   */
  public PaymentRequestAvroModel(java.util.UUID id, java.util.UUID sagaId, java.util.UUID customerId, java.util.UUID downloadId, java.math.BigDecimal price, java.time.Instant createdAt, com.model.download.system.kafka.download.avro.model.PaymentDownloadStatus paymentStatus) {
    this.id = id;
    this.sagaId = sagaId;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 6: paymentStatus = (com.model.download.system.kafka.download.avro.model.PaymentDownloadStatus)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public com.model.download.system.kafka.download.avro.model.PaymentDownloadStatus getPaymentStatus() {
   ...
   * @param value the value to set.
   */
  public void setPaymentStatus(com.model.download.system.kafka.download.avro.model.PaymentDownloadStatus value) {
   ...
   */
  public static com.model.download.system.kafka.download.avro.model.PaymentRequestAvroModel.Builder newBuilder() {
    return new com.model.download.system.kafka.download.avro.model.PaymentRequestAvroModel.Builder();
  }
   ...
   * @return A new PaymentRequestAvroModel RecordBuilder
   */
  public static com.model.download.system.kafka.download.avro.model.PaymentRequestAvroModel.Builder newBuilder(com.model.download.system.kafka.download.avro.model.PaymentRequestAvroModel.Builder other) {
    if (other == null) {
      return new com.model.download.system.kafka.download.avro.model.PaymentRequestAvroModel.Builder();
    } else {
      return new com.model.download.system.kafka.download.avro.model.PaymentRequestAvroModel.Builder(other);
    }
  }
   ...
   * @return A new PaymentRequestAvroModel RecordBuilder
   */
  public static com.model.download.system.kafka.download.avro.model.PaymentRequestAvroModel.Builder newBuilder(com.model.download.system.kafka.download.avro.model.PaymentRequestAvroModel other) {
    if (other == null) {
      return new com.model.download.system.kafka.download.avro.model.PaymentRequestAvroModel.Builder();
    } else {
      return new com.model.download.system.kafka.download.avro.model.PaymentRequestAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaymentRequestAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.model.download.system.kafka.download.avro.model.PaymentRequestAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.model.download.system.kafka.download.avro.model.PaymentRequestAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.model.download.system.kafka.download.avro.model.PaymentRequestAvroModel.Builder setId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.model.download.system.kafka.download.avro.model.PaymentRequestAvroModel.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.model.download.system.kafka.download.avro.model.PaymentRequestAvroModel.Builder setSagaId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.model.download.system.kafka.download.avro.model.PaymentRequestAvroModel.Builder clearSagaId() {
      sagaId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.model.download.system.kafka.download.avro.model.PaymentRequestAvroModel.Builder setCustomerId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.model.download.system.kafka.download.avro.model.PaymentRequestAvroModel.Builder clearCustomerId() {
      customerId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.model.download.system.kafka.download.avro.model.PaymentRequestAvroModel.Builder setDownloadId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.model.download.system.kafka.download.avro.model.PaymentRequestAvroModel.Builder clearDownloadId() {
      downloadId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.model.download.system.kafka.download.avro.model.PaymentRequestAvroModel.Builder setPrice(java.math.BigDecimal value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.model.download.system.kafka.download.avro.model.PaymentRequestAvroModel.Builder clearPrice() {
      price = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.model.download.system.kafka.download.avro.model.PaymentRequestAvroModel.Builder setCreatedAt(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.model.download.system.kafka.download.avro.model.PaymentRequestAvroModel.Builder clearCreatedAt() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.model.download.system.kafka.download.avro.model.PaymentRequestAvroModel.Builder setPaymentStatus(com.model.download.system.kafka.download.avro.model.PaymentDownloadStatus value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.model.download.system.kafka.download.avro.model.PaymentRequestAvroModel.Builder clearPaymentStatus() {
      paymentStatus = null;
    ...
    public PaymentRequestAvroModel build() {
      try {
        ...
        record.paymentStatus = fieldSetFlags()[6] ? this.paymentStatus : (com.model.download.system.kafka.download.avro.model.PaymentDownloadStatus) defaultValue(fields()[6]);
        return record;
